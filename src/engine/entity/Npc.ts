import { NpcInfoProt } from '#/network/rsbuf/index.ts';
...
import { NpcEventRequest, NpcEventType } from '#/engine/entity/NpcEventRequest.ts';
import { NpcMode } from '#/engine/entity/NpcMode.js';
import { NpcQueueRequest } from '#/engine/entity/NpcQueueRequest.ts';
