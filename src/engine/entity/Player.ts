...
import type { EntityTimer } from '#/engine/entity/EntityTimer.js';
import { PlayerTimerType } from '#/engine/entity/EntityTimer.js';
import HeroPoints from '#/engine/entity/HeroPoints.ts';
import Loc from '#/engine/entity/Loc.js';
import { ModalState } from '#/engine/entity/ModalState.ts';
...
export default class Player extends PathingEntity {
    ...
    save() {
        ...
        // sav.p4(Packet.getcrc(sav.data, 0, sav.pos)); todo
    ...
    invStopListenOnCom(com: number) {
        ...
        // this.write(new UpdateInvStopTransmit(com)); todo
    }
