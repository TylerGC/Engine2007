...
import { HitType } from '#/engine/entity/HitType.ts';
import { HuntVis } from '#/engine/entity/hunt/HuntVis.ts';
import { MapFindSquareType } from '#/engine/entity/MapFindSquareType.ts';
import { NpcMode } from '#/engine/entity/NpcMode.js';
import { NpcStat } from '#/engine/entity/NpcStat.ts';
